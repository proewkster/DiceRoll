    ...
    <div class="bg-modal">
        <div class="custom-modal-content">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to DiceRoll.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to DiceRoll, accessible from <a href="http://www.diceroll.com" rel="external nofollow noopener" target="_blank">http://www.diceroll.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: r0444972@student.thomasmore.be</li>
            </ul>
        </div>
    </div>
